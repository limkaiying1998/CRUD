...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
     ...
     <section class="navbar navbar-default navbar-static-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="index.jsp" class="navbar-brand">NewLife</a>
                    
                    <i style="color:#008000; text-align: right">Your original password has been sent to your email please re-login.</i>
               </div>
     ...
     <!-- HOME -->
     <section id="home" class="slider" data-stellar-background-rtio="0.5">
          <div class="container">
               <div class="row">
                              ...
                              <div class="item item-first">
                                   <div class="caption">
                                        <div class="col-md-offset-1 col-md-10">
                                    		 ...
                                    		 <a href="donorloginregister.jsp" class="section-btn btn btn-default smoothScroll" >Donor</a>
                                             <a href="hrmanagerlogin.jsp" class="section-btn btn btn-default smoothScroll">HR Manager</a>
                                             <a href="stafflogin.jsp" class="section-btn btn btn-default smoothScroll">Blood Bank Staff</a>
                                             <a href="nurselogin.jsp" class="section-btn btn btn-default smoothScroll">Nurse</a>
										</div>
                                        </div>
                                   </div>
