...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
                              ...
                              <div class="item item-first">
                                   <div class="caption">
                                        <div class="col-md-offset-1 col-md-10">
                                             ...
                                             <a href="searchbloodinventory.html" class="section-btn btn btn-default smoothScroll">Search</a>
                                        </div>
                                   </div>
							 </div>
  ...
  <form action="/action_page.php">
     <h3 style="color:#4CAF50 "><u>Search Blood Quantity</u></h1>
     <br/>
     
   <label for="bloodID">Blood ID</label>
    <select id="bloodtype" name="bloodID">
