...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
     ...
     <section class="navbar navbar-default navbar-static-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="hrmanagerpage.html" class="navbar-brand">NewLife</a>
               </div>
                              ...
                              <div class="item item-first">
                                   <div class="caption">
                                        <div class="col-md-offset-1 col-md-10">
                                             <h3>Add New Staff</h3>
                                             <h1>New Staff</h1>
                                             <a href="addstaff.html" class="section-btn btn btn-default smoothScroll">Add</a>
                                        </div>
                                   </div>
							 </div>
                          ...
                          <div class="item item-second">
                                   <div class="caption">
                                        <div class="col-md-offset-1 col-md-10">
                                             ...
                                             <a href="updatestaff.html" class="section-btn btn btn-default btn-gray smoothScroll">Update</a>
                                        </div>
                                   </div>
                              </div>
                               ...
                               <div class="item item-second">
                                   <div class="caption">
                                        <div class="col-md-offset-1 col-md-10">
                                             ...
                                             <h1>Search Staff</h1>
                                             <a href="searchstaff.html" class="section-btn btn btn-default btn-gray smoothScroll">Search</a>
                                        </div>
                                   </div>
                              </div>
                         </div>
  ...
  <form action="/action_page.php">
     <h3 style="color:#4CAF50 "><u>Staff Management</u></h1>
     <br/>
     
      <label for="staffName">Staff Name</label>
    <input type="text" id="name" name="staffName" size="50" placeholder="Staff new name..">
     
     <label for="staffIC">Staff Identification Number</label>
    <input type="text" id="IC" name="staffIC" size="12" placeholder="Staff new IC..">
    ...
    <input type="text" id="address" name="staffAddress" size="100" placeholder="Staff new Address..">
       
       <label for="staffEmail">Staff Email</label>
    <input type="email" id="email" name="staffEmail" size="50" placeholder="Staff new Email..">
    
    <label for="staffrEmail">Staff Contact</label>
    <input type="text" id="contact" name="staffContact" size="11" placeholder="Staff new Contact Number..">
