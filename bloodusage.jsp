...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
  ...
  <form action="/action_page.php">
     <h3 style="color:#4CAF50 "><u>Blood Usage</u></h1>
     <br/>
     <label for="usage">Description Of Usage Transaction</label>
   ...
   <label for="bloodID">Blood ID</label>
    <select id="bloodtype" name="bloodID">
      ...
      <label for="bloodQuantity">Blood Quantity (between 1 and 100)</label>
  <input type="number" name="bloodQuantity" min="1" max="100"><br>
