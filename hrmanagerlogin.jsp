  ...
  <div class="form">
      ...
      <ul class="tab-group">
        ...
        <div id="login">   
          ...
          <form action="hrmanagerlogin" method="post">
          ...
          <div class="field-wrap">
           <h3>Password</h3>
            <input type="password" name="staffPassword" size="15" required="required"/>
          </div>
          
          <p class="forgot"><a href="passwordrecovery.html">Forgot Password?</a></p>
