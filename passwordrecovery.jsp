...
<body>
  ...
  <div class="form">
      ...
      <ul class="tab-group">
        <li class="tab active"><a href="#login">Password Recovery</a></li>
      </ul>
        ...
        <div id="passwordrecovery">   
          ...
          <div class="field-wrap">
           <h3>Enter Your Username</h3>
            <input type="text" name ="staffUsername" size="50" required="required"/>
          </div>


          <!---<button formaction="recoverycode.jsp" class="button button-block"/>Send Recovery Code Now</button>--->
           <button type="submit" class="button button-block"/>Send Recovery Code Now</button>
          </form>
