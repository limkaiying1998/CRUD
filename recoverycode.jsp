...
<body>
  ...
  <div class="form">
      ...
      <ul class="tab-group">
        <li class="tab active"><a href="#login">Recovery Code</a></li>
      </ul>
        ...
        <div id="passwordrecovery">   
          ...
          <form action="recoverycode" method="post">
          
          <div class="field-wrap">
           <h3>Enter Your Recovery Code</h3>
            <input type="text" name="recoveryCode" size="5" maxlength="5" required="required" placeholder="Eg:56894"/>
          </div>


          <!---<button formaction="newpassword.jsp" class="button button-block"/>Confirm</button>--->
